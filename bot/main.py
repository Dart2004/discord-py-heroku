...
async def text(ctx,style,*,arg):
  ...
  embed.set_image(url="https://flamingtext.com/net-fu/proxy_form.cgi?imageoutput=true&script="+style+"-logo&doScale=true&scaleWidth=240&scaleHeight=120&backgroundRadio=2&backgroundPattern=Purple+Glow&text="+str(arg).replace(" ","%20"))
  await ctx.send(embed=embed)
